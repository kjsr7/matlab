...
w_damp = 0.99 ;                         %Damping coefficient of Inertial weight
...
min = -30 ;                           %Minimum vlaue of any dimension
max =  30 ;                           %Maximum value of any dimension
fitnessFunction = @(x) ackley (x,number_of_dimensions) ;  %Fitness function to be optimized
